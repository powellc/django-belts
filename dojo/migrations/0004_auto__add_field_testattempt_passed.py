...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestAttempt.passed'
        db.add_column(u'dojo_testattempt', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestAttempt.passed'
        db.delete_column(u'dojo_testattempt', 'passed')
    ...
    models = {
        ...
        u'dojo.discipline': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'dojo.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 30, 0, 0)', 'null': 'True', 'blank': 'True'}),
